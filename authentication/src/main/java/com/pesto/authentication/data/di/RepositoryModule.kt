...
object RepositoryModule{
    @Provides
    @Singleton
     fun provideSignUpRepository(@Named("Auth") databaseReference: DatabaseReference,profileDao: ProfileDao,sharedPreferences: SharedPreferences):SignUpRepository{
        return SignUpRepositoryImpl(databaseReference,profileDao,sharedPreferences)
     }
}